...
class CustomTokenObtainPairSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if user is None:
            ...
            raise serializers.ValidationError('The email or password you entered is incorrect. Please try again.')
        ...
        if user_type == 'company':
            try:
                ...
                raise serializers.ValidationError('This account is registered as an influencer. Please use the influencer login.')
            ...
            try:
                ...
                raise serializers.ValidationError('This account is registered as a company. Please use the company login.')
        else:
